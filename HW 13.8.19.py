tickets = int(input('При регистрации больше 3-х человек на конференцию действует скидка 10% от стоимости заказа!\n'
...
for i in age:
    if i in range(0, 18):
        ...
        price.append(1390)
if tickets > 3:
    print('Сумма к оплате с учётом скидки:', sum(price) - ((sum(price) / 100) * 10), 'рублей')
else:
